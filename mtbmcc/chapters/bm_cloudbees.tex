...
\begin{longtable}{|L{\column}|L{\column}|L{\column}|L{\column}|}
	...
	\multicolumn{2}{|L{\columnT}|}{
		\vspace{-5mm} 
		\begin{itemize}[leftmargin=*, parsep=0pt, topsep=0pt, itemsep=0pt]
				\item CloudBees platform as a service truly dedicated to Java and Java Virtual Machine (JVM) applications (clear mission)
...
\multicolumn{2}{|L{\columnT}|}{
	...
	\begin{itemize}[leftmargin=*, parsep=0pt, topsep=0pt, itemsep=0pt]
				...
				\item Partnership with IaaS providers, for instance Amazon Web Services\vspace{-\baselineskip} 
	\end{itemize}
} &
% KEY PPROCESSES
\multicolumn{2}{|L{\columnT}|}{
\vspace{-5mm} 
\begin{itemize}[leftmargin=*, parsep=0pt, topsep=0pt, itemsep=0pt]
				\item Maintain full lifecycle support for Java and Java Virtual Machine (JVM) applications as well as keep the platform up to date (in respect of new Java versions and features)
				\item Facilitate different deployment scenarios -- public, private, and hybrid -- based on multiple IaaS providers
				\item Maintain partnerships with existing IaaS providers as well as begin negotiations with potential providers
	...
	\begin{itemize}[leftmargin=*, parsep=0pt, topsep=0pt, itemsep=0pt]
				\item Subscription and transaction based revenue for platform usage:
					\begin{itemize}[leftmargin=*, topsep=0pt, itemsep=0pt]
						...
						\item RUN@cloud Dedicated: Different IaaS providers, e.g. AWS US m1.small USD 153 \/ Monthly
