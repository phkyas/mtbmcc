...
The desired outcome of the thesis at hand is threefold. First, it is aimed to develop a classification scheme as result for the sub-research question 1. By utilizing the concept of system dynamics the other two sub-research questions are attacked. Second, a qualitative model (\ac{CLD}) should illustrate the interdependencies within \ac{PaaS} business models and constitutes the answer for the sub-research question 2. Third, this model is further developed into a quantitative model (\ac{SFD}) and represents the result of the sub-research question 3 as well as the final outcome of this thesis.
