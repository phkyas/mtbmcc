...
\begin{longtable}{L{\column}L{\column}L{\column}L{\column}}
	...
	\footnotesize 	
	Platform Customer (large enterprises and upper \acp{SME}) &
	\footnotesize 
...
\begin{itemize}[leftmargin=*, parsep=0pt, topsep=0pt, itemsep=0pt]
				...
				\item Efficient low cost sales channel (for instance self-service)
	...
	\begin{itemize}[leftmargin=*, parsep=0pt, topsep=0pt, itemsep=0pt]
				\item Platform subscription:
					\begin{itemize}[leftmargin=*, topsep=0pt, itemsep=0pt]
						\item SAP HANA Cloud packages: \ac{EUR} 370 - 16.000 / Monthly or
				...
				\item Application certification fee: initial \ac{EUR} 990, yearly recurring \ac{EUR} 495 
