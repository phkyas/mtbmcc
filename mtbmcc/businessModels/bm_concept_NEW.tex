...
\begin{longtable}{L{\column}L{\column}L{\column}L{\column}}
	...
	\multicolumn{4}{c}{\textbf{\small Customer Value Proposition (CVP)}}\\ \midrule
	...
	\multicolumn{2}{L{\columnT}}{\footnotesize \textbf{Offering}, which satisfies the problem or fulfills the need. This is defined not only by what is sold but also by how it's sold.} \\ \midrule

% KEY RESOURCES
\multicolumn{2}{L{\columnT}}{\textbf{\small Key Resources} \footnotesize needed to deliver the customer value proposition profitably. Might include:
...
\multicolumn{2}{L{\columnT}}{\textbf{\small Key Processes} \footnotesize as well as rules, metrics, and norms, that make the profitable delivery of the customer value proposition repeatable and scalable. Might include:
\begin{itemize}[leftmargin=*, parsep=0pt, topsep=0pt, itemsep=0pt]
...
% PROFIT FORMULA
\multicolumn{4}{L{\columnF}}{\textbf{\small Profit Formula} \footnotesize
\begin{itemize}[leftmargin=*, parsep=0pt, topsep=0pt, itemsep=0pt]
