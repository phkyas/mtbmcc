...
\begin{longtable}{L{\column}L{\column}L{\column}L{\column}}
	...
	\footnotesize
	Manage the entire Java application lifecycle within the cloud in a cost-efficient manner & 
	...
	\begin{itemize}[leftmargin=*, parsep=0pt, topsep=0pt, itemsep=0pt]
				...
				\item CloudBees partner ecosystem provides platform extensions, such as databases, monitoring as well as deployment tools\vspace{-\baselineskip} 
		\end{itemize}
	} \\ \midrule
	\footnotesize	
	\ac{ISV} &
	...
	\multicolumn{2}{L{\columnT}}{
		...
		\footnotesize
		\begin{itemize}[leftmargin=*, parsep=0pt, topsep=0pt, itemsep=0pt]
				\item CloudBees platform as a service solely intended for Java and \ac{JVM} applications (clear mission)
				\item Service and application listing within the Ecosystem Technology Partner directory
...
\footnotesize
\begin{itemize}[leftmargin=*, parsep=0pt, topsep=0pt, itemsep=0pt]
				\item Maintain full lifecycle support for Java and \ac{JVM} applications as well as keep the platform up to date (with respect to new Java versions and features)
				...
				\item Partner program for consulting partners, including business and marketing support, access to products plans, training, reselling options, and listing in the CloudBees Service Partner Directory
