...
\begin{longtable}{L{\column}L{\column}L{\column}L{\column}}
	...
	\ac{ISV} &
	\footnotesize 
	Develop and market browser as well as mobile applications and games & 
	...
	Advertising Broker &
	\footnotesize 
	Act as an intermediary between advertisers and developers or application providers &
	\multicolumn{2}{L{\columnT}}{
		\vspace{-5mm} 
		\footnotesize 
		\begin{itemize}[leftmargin=*, parsep=0pt, topsep=0pt, itemsep=0pt]
	...
	\footnotesize 
	Participation in a social network including diverse games and applications &
	\multicolumn{2}{L{\columnT}}{
		\vspace{-5mm} 
		\footnotesize 
		\begin{itemize}[leftmargin=*, parsep=0pt, topsep=0pt, itemsep=0pt]
...
Possible scenario: An application user buys equipment paid by Facebook Credits within a game. The application provider changes these credits into real money -- Facebook retains a 30\% charge.
